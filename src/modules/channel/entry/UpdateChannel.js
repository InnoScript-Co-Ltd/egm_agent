...
export const UpdateChannel = () => {
    ...
    const [payload, setPayload] = useState(channelPayload.update);
    ...
    const updateHandler = async () => {
        ...
        const result = await channelServices.update(dispatch, updatePayload, params.id);
                        ...
                        <div className='row'>
                            <div className='col-12'>
                                <div className="alert alert-warning">
                                    <InfoCircle size={60} />
                                    <p> Total commission ROI rate is 4% and sub agent can split commission % by percentage patterns. </p>
                                </div>
                            </div>
                                ...
                                <div className="row mt-3 mb-3">
                                    ...
                                    <div className="col-12 col-md-4 col-lg-4">
                                        <Form.Group className="mt-3 w-full" controlId="channel.percentage_pattern">
                                            <Form.Select
                                                disabled={loading}
                                                value={payload.percentage_pattern ? payload.percentage_pattern : ""}
                                                onChange={(e) => {
